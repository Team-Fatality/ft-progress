...
RegisterNetEvent("ftprogress:start")
RegisterNetEvent("ftprogress:stop")
RegisterNetEvent("ftprogress:custom")
RegisterNetEvent("ftprogress:linear")
RegisterNetEvent("ftprogress:minigame")

AddEventHandler("ftprogress:start", Start)
AddEventHandler("ftprogress:stop", Stop)
AddEventHandler("ftprogress:custom", function(options)
    options.Async = false
    options.onStart = nil
    options.onComplete = nil
...
AddEventHandler("ftprogress:linear", Linear)
AddEventHandler("ftprogress:minigame", MiniGame)
